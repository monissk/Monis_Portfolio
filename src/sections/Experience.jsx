    ...
    <section id="experience" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          >
            My journey as a developer has been driven by continuous learning, hands-on projects, and real-world experience. From building full-stack web applications to developing AI-powered solutions, every step has strengthened my technical skills and passion for software engineering..
          </p>
        </div>

        {/* Timeline */}
        <div className="relative ml-0 md:left-1/4">
          ...
          <div className="space-y-15">
            {experiences.map((exp, idx) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-0 top-0 w-3 h-3 bg-primary rounded-full -translate-x-1/2 ring-4 ring-background z-10">
                  {exp.current && (
